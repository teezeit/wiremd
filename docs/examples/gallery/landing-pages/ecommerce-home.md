...
|---------|----------|-------|--------|-------|
| ![IMG] Classic White Tee | Clothing | $24.99 | :star::star::star::star::star: | In Stock |
| ![IMG] Denim Jacket | Outerwear | $89.99 | :star::star::star::star: | Low Stock |
| ![IMG] Leather Boots | Footwear | $149.99 | :star::star::star::star::star: | In Stock |
| ![IMG] Crossbody Bag | Accessories | $59.99 | :star::star::star::star: | In Stock |
...
Shop seasonal favorites at unbeatable prices
...
Subscribe to receive special offers, style tips, and early access to sales.

Email Address
[your@email.com___________] {type:email}
...
[[ :instagram: Instagram | :facebook: Facebook | :pinterest: Pinterest | :twitter: Twitter | :youtube: YouTube ]]

**@shophub** • Tag us to be featured!
...
**Phone:** 1-800-SHOP-HUB (24/7)

**Common Questions:**
- [Track My Order](https://example.com/tracking)
...
[[ :visa: Visa | :mastercard: Mastercard | :amex: Amex | :paypal: PayPal | :applepay: Apple Pay | :googlepay: Google Pay ]]
...
**Style Variations:**
- `sketch` - Quick prototype for stakeholders
- `clean` - Modern, professional e-commerce
- `wireframe` - Focus on content structure
- `tailwind` - Contemporary retail aesthetic
- `material` - Google Shopping style
- `brutal` - Bold, distinctive brand
- `none` - Semantic markup for frameworks

**Generate this example:**
```bash
wiremd ecommerce-home.md --style sketch
wiremd ecommerce-home.md --style clean -o ecommerce-clean.html
wiremd ecommerce-home.md --style material -o ecommerce-material.html
```
