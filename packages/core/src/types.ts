...
export type WiremdNode =
  ...
  | { type: 'select'; props: ComponentProps & { placeholder?: string; required?: boolean; disabled?: boolean; multiple?: boolean; value?: string }; options: Array<{ type: 'option'; value: string; label: string; selected?: boolean; href?: string; action?: string; position?: Location }>; position?: Location }
  | { type: 'option'; value: string; label: string; selected?: boolean; href?: string; action?: string; position?: Location }
